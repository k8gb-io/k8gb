...
"http": {
SchemaProps: spec.SchemaProps{
Ref: ref("struct{Paths []struct{Backend struct{ServiceName string "json:\"serviceName\""; ServicePort string "json:\"servicePort\""} "json:\"backend\""; Path string "json:\"path\""} "json:\"paths\""}"),
},
},
"strategy": {
SchemaProps: spec.SchemaProps{
...
"tls": {
SchemaProps: spec.SchemaProps{
Ref: ref("struct{SecretName string "json:\"secretName\""}"),
},
},
},
Required: []string{"host","http","strategy","tls"},
},
},
Dependencies: []string{
"struct{Paths []struct{Backend struct{ServiceName string "json:\"serviceName\""; ServicePort string "json:\"servicePort\""} "json:\"backend\""; Path string "json:\"path\""} "json:\"paths\""}","struct{SecretName string "json:\"secretName\""}",},
}
}
