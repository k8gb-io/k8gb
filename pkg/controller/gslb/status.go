...
func (r *ReconcileGslb) updateGslbStatus(gslb *k8gbv1beta1.Gslb) error {
	var err error
...
func (r *ReconcileGslb) getServiceHealthStatus(gslb *k8gbv1beta1.Gslb) (map[string]string, error) {
...
func (r *ReconcileGslb) getHealthyRecords(gslb *k8gbv1beta1.Gslb) (map[string][]string, error) {
