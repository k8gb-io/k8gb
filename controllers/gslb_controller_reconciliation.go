...
func (r *GslbReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	refResolver, err := refresolver.New(gslb, r.Client, r.Logger)
	if err != nil {
		m.IncrementError(gslb)
	...
	epProvider := k8gbendpoint.NewApplicationDNSEndpoint(context.TODO(), r.Client, r.Config, gslb, r.Logger, r.updateRuntimeStatus)
