...
func testResolution(t *testing.T, parentDNS utils.DNSServer) {
	tests := []struct {
		...
		},
		{
			...
			expectedError: false,
			result: resolver.ClusterNSNames{
				"gslb-ns-eu-test-1-cloud-complex.example.com": resolver.NewGeoTag(false, "eu-test-1"),
				"gslb-ns-us-test-1-cloud-complex.example.com": resolver.NewGeoTag(true, "us-test-1"),
			},
		},
		{
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			assert.True(t, resolver.EqualClusterNSNames(test.result, result))
		})
	}
}
