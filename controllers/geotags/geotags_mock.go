...
func (m *MockGeoTags) GetExternalClusterNSNamesByHostname(ctx context.Context, host string) (map[string]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExternalClusterNSNamesByHostname", ctx, host)
...
func (mr *MockGeoTagsMockRecorder) GetExternalClusterNSNamesByHostname(ctx, host any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExternalClusterNSNamesByHostname", reflect.TypeOf((*MockGeoTags)(nil).GetExternalClusterNSNamesByHostname), ctx, host)
}
