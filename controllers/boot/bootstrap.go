...
func GetBootstrap(ctx context.Context, config *depresolver.Config, logger *zerolog.Logger, kubeconfig *rest.Config) (*Bootstrap, error) {
...
func readIPs(ctx context.Context, cl client.Client, config *depresolver.Config, logger *zerolog.Logger) (*Bootstrap, error) {
	...
	coreDNSAssistant := assistant.NewCoreDNSServiceAssistant(cl, *config, logger)
