...
// Source: github.com/infobloxopen/infoblox-go-client/v2 (interfaces: IBConnector)
...
func (m *MockIBConnector) GetObject(arg0 ibclient.IBObject, arg1 string, arg2 *ibclient.QueryParams, arg3 interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockIBConnectorMockRecorder) GetObject(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetObject", reflect.TypeOf((*MockIBConnector)(nil).GetObject), arg0, arg1, arg2, arg3)
}
