...
type Provider interface {
	...
	CreateZoneDelegationForExternalDNS(*k8gbv1beta1.Gslb, utils.DNSZone) error
	// GetExternalTargets retrieves list of external targets for specified host
	GetExternalTargets(string, utils.DNSZone) assistant.Targets
	...
	Finalize(*k8gbv1beta1.Gslb, utils.DNSZone) error
