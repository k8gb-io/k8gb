...
type Assistant interface {
	...
	// GetCoreDNSLoadBalancerServiceIPs retrieves list of exposed IP by CoreDNS
	GetCoreDNSLoadBalancerServiceIPs() ([]string, error)
	// GetIngressStatusIPs retrieves list of exposed IP by CoreDNS
	GetIngressStatusIPs() ([]string, error)
