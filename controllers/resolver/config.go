...
type Config struct {
	...
	DNSZones string `env:"DNS_ZONES" required:"" help:"pairs of parentZone ad loadBalancedZone, eg: DNS_ZONES=example.com:cloud.example.com;example.io:cloud.example.io"`
