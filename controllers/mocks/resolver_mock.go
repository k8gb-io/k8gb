...
// Source: controllers/resolver/resolver.go
//
...
// GetDeprecations mocks base method.
func (m *MockGslbResolver) GetDeprecations() []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeprecations")
	ret0, _ := ret[0].([]string)
	return ret0
}

// GetDeprecations indicates an expected call of GetDeprecations.
func (mr *MockGslbResolverMockRecorder) GetDeprecations() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeprecations", reflect.TypeOf((*MockGslbResolver)(nil).GetDeprecations))
}
...
func (m *MockGslbResolver) ResolveOperatorConfig() (*resolver.Config, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolveOperatorConfig")
	ret0, _ := ret[0].(*resolver.Config)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
