...
// GetCoreDNSLoadBalancerServiceIPs mocks base method.
func (m *MockAssistant) GetCoreDNSLoadBalancerServiceIPs() ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCoreDNSLoadBalancerServiceIPs")
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetCoreDNSLoadBalancerServiceIPs indicates an expected call of GetCoreDNSLoadBalancerServiceIPs.
func (mr *MockAssistantMockRecorder) GetCoreDNSLoadBalancerServiceIPs() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCoreDNSLoadBalancerServiceIPs", reflect.TypeOf((*MockAssistant)(nil).GetCoreDNSLoadBalancerServiceIPs))
}
...
// GetIngressStatusIPs mocks base method.
func (m *MockAssistant) GetIngressStatusIPs() ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIngressStatusIPs")
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetIngressStatusIPs indicates an expected call of GetIngressStatusIPs.
func (mr *MockAssistantMockRecorder) GetIngressStatusIPs() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIngressStatusIPs", reflect.TypeOf((*MockAssistant)(nil).GetIngressStatusIPs))
}
