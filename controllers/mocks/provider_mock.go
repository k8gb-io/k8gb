...
func (m *MockProvider) CreateZoneDelegation(arg0 *depresolver.DelegationZoneInfo) error {
	m.ctrl.T.Helper()
...
func (m *MockProvider) Finalize(arg0 *depresolver.DelegationZoneInfo) error {
	m.ctrl.T.Helper()
