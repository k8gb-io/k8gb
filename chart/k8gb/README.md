...
![Version: v0.15.0-rc2](https://img.shields.io/badge/Version-v0.15.0--rc2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.15.0-rc2](https://img.shields.io/badge/AppVersion-v0.15.0--rc2-informational?style=flat-square)
...
|------------|------|---------|
| https://coredns.github.io/helm | coredns | 1.42.3 |
...
| tracing.jaegerImage.tag | string | `"1.70.0"` |  |
...
| tracing.sidecarImage.tag | string | `"0.128.0"` |  |
