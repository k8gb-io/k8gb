...
| k8gb.ingressController | object | `{"healthCheck":{"enabled":false,"serviceName":"","serviceNamespace":""}}` | Ingress controller health check configuration |
| k8gb.ingressController.healthCheck.enabled | bool | `false` | Enable health checking for the ingress controller/load balancer. When enabled, k8gb considers both application health and ingress controller health in failover decisions |
| k8gb.ingressController.healthCheck.serviceName | string | `""` | Name of the service that exposes the ingress controller.' |
| k8gb.ingressController.healthCheck.serviceNamespace | string | `""` | Namespace of the ingress controller service. Required if serviceName is specified |
...
| tracing.sidecarImage.tag | string | `"0.137.0"` |  |
